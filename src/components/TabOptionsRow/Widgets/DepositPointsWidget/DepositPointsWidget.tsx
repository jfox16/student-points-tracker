...
export const DepositPointsWidget: React.FC<DepositPointsWidgetProps> = ({ className }) => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
